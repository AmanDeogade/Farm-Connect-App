...
class TwoFarmerDisplayOrderScreen extends ConsumerStatefulWidget {
  const TwoFarmerDisplayOrderScreen({super.key});

  @override
  ConsumerState<TwoFarmerDisplayOrderScreen> createState() =>
      _OrderScreenState();
}
